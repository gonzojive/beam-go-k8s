...
// Program beam-go-k8s is an example Beam pipeline dervied from the wordcount
// example.
//
...
// minimal_wordcount. After you've looked at this example, then see the
// debugging_workcount pipeline, for introduction of additional concepts.
//
...
// selecting another runner. These are now command-line options added by the
// 'beamx' package and not hard-coded as they were in the minimal_wordcount
...
//
// To execute this pipeline, specify a local output file (if using the 'direct'
// runner) or a remote file on a supported distributed file system.
//
